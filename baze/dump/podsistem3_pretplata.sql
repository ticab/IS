...
CREATE TABLE `pretplata` (
  ...
  KEY `idPak_idx` (`idPak`),
  KEY `idKor_idx` (`idKor`),
  CONSTRAINT `pretplataKorisnik` FOREIGN KEY (`idKor`) REFERENCES `korisnik` (`idKor`) ON UPDATE CASCADE,
  CONSTRAINT `pretplataPaket` FOREIGN KEY (`idPak`) REFERENCES `paket` (`idPak`) ON UPDATE CASCADE
...
INSERT INTO `pretplata` VALUES (1,'2022-07-01 10:00:00',500.00,1,1);
