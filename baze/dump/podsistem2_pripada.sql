...
CREATE TABLE `pripada` (
  ...
  KEY `idKat_idx` (`idKat`),
  CONSTRAINT `pripadaKat` FOREIGN KEY (`idKat`) REFERENCES `kategorija` (`idKat`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pripadaVideo` FOREIGN KEY (`idVid`) REFERENCES `video` (`idVid`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pripada` VALUES (1,2),(2,3);
